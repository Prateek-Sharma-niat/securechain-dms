 ...
 * - Dedicated chakra-blue sidebar links: Home, Cases Pending Verification, Hash Verification Tool, Quorum Approval, Audit Log (read-only), Settings
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
            ...
            <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 shadow-xs space-y-2">
              ...
              <p className="text-[11px] text-slate-500 dark:text-slate-400">
                Ledger hash parity under BSA §63
              </p>
            </div>
